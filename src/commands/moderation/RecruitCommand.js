...
module.exports = class RecruitCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    const staffRole = message.guild.roles.cache.get('818992469425389616');
    ...
    const sEmbed = new Discord.MessageEmbed()
      ...
      .setDescription("¡Hola! \n\ Bienvenido al equipo de moderadores del servidor de ORT 1E! \n\ Se te pide releer las reglas. Para revisar los comandos de moderacion que es OBLIGATORIO, usar el comando `o!modcommands`")
    ...
    if (!mentionedMember.user.id == message.author.id) return message.channel.send('🛑No podes ser estaff vos mismo ya lo sos xDD🛑')
